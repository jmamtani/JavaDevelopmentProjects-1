...
public final class CryptoUtilities {
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        // TODO - fill in body
        NaturalNumber nNew = n.newInstance();
        NaturalNumber pNew = p.newInstance();
        ...
        NaturalNumber rmndr = n.divide(m);
        n.transferFrom(rmndr);
        } else {
          p.divide(two);
          NaturalNumber newCopy = n.newInstance();
          newCopy.copyFrom(n);
          n.multiply(newCopy);
          n.multiply(nNew);
         }
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        //checking with sample value and updating
        powerMod(w, one, n);
        if (!w.isZero()) {
             w.decrement();
             if (w.isZero()) {
        ...
        n.decrement();//decrement if not true
